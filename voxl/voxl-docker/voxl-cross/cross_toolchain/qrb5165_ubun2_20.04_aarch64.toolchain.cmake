## This is the recommended toolchain for building for QRB5165 ubun2 20.04
## in a cross-compile environment like voxl-cross
## This targets glibc 2.31 and CXXABI_1.3.12

set(CMAKE_SYSTEM_NAME Linux)
set(CMAKE_SYSTEM_PROCESSOR aarch64)
set(CMAKE_C_COMPILER_TARGET aarch64-linux-gnu)
set(CMAKE_CXX_COMPILER_TARGET aarch64-linux-gnu)
set(TARGET_SYSROOT /opt/sysroots/qrb5165_2)
set(CMAKE_CROSSCOMPILING ON CACHE BOOL "Cross-compiling" FORCE)

# gcc 10 is the latest on focal but 9 is what's installed by default so mimic that
set(tools /usr)
set(CMAKE_C_COMPILER ${tools}/bin/aarch64-linux-gnu-gcc-9 CACHE STRING "" FORCE)
set(CMAKE_CXX_COMPILER ${tools}/bin/aarch64-linux-gnu-g++-9 CACHE STRING "" FORCE)
...
-isystem=/usr/include \
-idirafter ${TARGET_SYSROOT}/usr/include/linux-msm/usr/include \
-idirafter /usr/include")

set(CMAKE_CXX_FLAGS_INIT "\
-isystem=/usr/include/c++/9 \
-isystem=/usr/include/aarch64-linux-gnu/c++/9 \
...
-L${TARGET_SYSROOT}/usr/lib/gcc/aarch64-linux-gnu/9 \
-L${TARGET_SYSROOT}/usr/aarch64-linux-gnu/lib \
...
# for QRB5165, install 64-bit libraries to lib64, 32-bit libs go in /usr/lib
set(LIB_INSTALL_DIR /usr/lib64)
set(PLATFORM "QRB5165_2")
...
message(STATUS "---------------------------------------------------------")
message(STATUS "Using voxl-cross 64-bit toolchain for QRB5165 ubun2 20.04")
