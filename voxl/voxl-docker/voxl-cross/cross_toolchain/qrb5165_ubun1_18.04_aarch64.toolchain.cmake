## This is the recommended toolchain for building for QRB5165 ubun1 18.04 platform
## in a cross-compile environment like voxl-cross
## This targets glibc 2.27 and CXXABI_1.3.11
...
# the qrb5165 ubun1 18.04 chipcode ships with gcc7, don't risk mismatches between
# glibc versions and just stick with one common compiler.
set(tools /usr)
set(CMAKE_C_COMPILER ${tools}/bin/aarch64-linux-gnu-gcc-7 CACHE STRING "" FORCE)
set(CMAKE_CXX_COMPILER ${tools}/bin/aarch64-linux-gnu-g++-7 CACHE STRING "" FORCE)
...
# aarch64-linux-gnu-g++ -E -x c++ - -v < /dev/null
...
-isystem=/usr/lib/gcc/aarch64-linux-gnu/7/include-fixed \
...
-isystem=/usr/include/aarch64-linux-gnu/c++/7 \
...
-L${TARGET_SYSROOT}/usr/lib/gcc/aarch64-linux-gnu/7 \
...
# helper to find opencv libraries in the sysroot
file(GLOB OpenCV_LIBS "${TARGET_SYSROOT}/usr/lib64/libopencv*.so")
...
message(STATUS "---------------------------------------------------------")
message(STATUS "Using voxl-cross 64-bit toolchain for QRB5165 ubun1 18.04")
